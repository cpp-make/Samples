...
private:
    ...
    // 1サンプル分の波形の計算
    double processSample(double angle, WaveType waveType, int ch);
    ...
    std::array<double, 2> m_lastValue;
    ...
    /// @brief phaseパラメータ変更時に音をスムーズにする
    juce::SmoothedValue<double> m_phase {0.0};
